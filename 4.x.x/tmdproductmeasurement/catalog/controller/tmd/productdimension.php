...
class Productdimension extends \Opencart\System\Engine\Controller {	
...
/* 19 06 2020 */
			...
			$setting_info = $this->model_extension_tmdproductmeasurement_tmd_tmd_productdimension->getSqrSetting($product_id);
...
/* 19 06 2020 */
		...
		$this->load->model('extension/tmdproductmeasurement/tmd/tmd_productdimension');
		$data['sqrpriceinfos'] = $this->model_extension_tmdproductmeasurement_tmd_tmd_productdimension->getSqrPrices($product_id);
		$data['infos'] = $this->model_extension_tmdproductmeasurement_tmd_tmd_productdimension->getTmdProductPricestatus($product_id);
		if($data['infos']){		
			return $this->load->view('extension/tmdproductmeasurement/tmd/tmd_productdimension', $data);
	...
	public function quantityprice() {	
		$this->load->language('extension/tmdproductmeasurement/tmd/productdimension');
		$this->load->language('product/product');
		$this->load->model('extension/tmdproductmeasurement/tmd/tmd_productdimension');
		$this->load->model('catalog/product');
		$data['sqr_quantitys']=[];
		...
		$infos = $this->model_extension_tmdproductmeasurement_tmd_tmd_productdimension->getTmdProductPrice($product_id,$width,$height);
		...
		$this->response->setOutput($this->load->view('extension/tmdproductmeasurement/tmd/loadquantity', $data));
	}
