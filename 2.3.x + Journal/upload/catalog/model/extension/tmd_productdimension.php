...
class ModelExtensionTmdproductdimension extends Model {
	...
	public function getTmdProductPrice($product_id,$width,$height) {
		...
		$product_ids = $this->config->get('tmd_productdimension_pproducts');
		$manufacturer_ids = $this->config->get('tmd_productdimension_manufacturer');
		$categorie_ids = $this->config->get('tmd_productdimension_category');
		...
		if($status==true) {
			$sqrprice_info = $this->config->get('tmd_productdimension_productsqr');
